	...
	switch(resultid)
	{
		...
		case LOADUSERDATA_THREAD:
		{
			if(IsPlayerConnected(extraid))
			{
				...
				for(new row;row < rows;row++)
				{
					...
					cache_get_field_content(row,  "CuopCuaHang", szResult, MainPipeline); PlayerInfo[extraid][pCuopCuaHang] = strval(szResult);					
					cache_get_field_content(row,  "KhatNuoc", szResult, MainPipeline); PlayerInfo[extraid][pKhatNuoc] = strval(szResult);
					cache_get_field_content(row,  "Verified", szResult, MainPipeline); PlayerInfo[extraid][pVerified] = strval(szResult);
					...
					cache_get_field_content(row,  "FishermenSkill", szResult, MainPipeline); PlayerInfo[extraid][pFishermenSkill] = strval(szResult);
					cache_get_field_content(row,  "BuilderSkill", szResult, MainPipeline); PlayerInfo[extraid][pBuilderSkill] = strval(szResult);

					cache_get_field_content(row,  "RentBoat", szResult, MainPipeline); PlayerInfo[extraid][pRentBoat] = strval(szResult);
					cache_get_field_content(row,  "Shrimp", szResult, MainPipeline); PlayerInfo[extraid][pShrimp] = strval(szResult);
					cache_get_field_content(row,  "Salmon", szResult, MainPipeline); PlayerInfo[extraid][pSalmon] = strval(szResult);
					cache_get_field_content(row,  "Tuna", szResult, MainPipeline); PlayerInfo[extraid][pTuna] = strval(szResult);
					cache_get_field_content(row,  "Crab", szResult, MainPipeline); PlayerInfo[extraid][pCrab] = strval(szResult);
					cache_get_field_content(row,  "Lobster", szResult, MainPipeline); PlayerInfo[extraid][pLobster] = strval(szResult);
					cache_get_field_content(row,  "ShrimpProcessed", szResult, MainPipeline); PlayerInfo[extraid][pShrimpProcessed] = strval(szResult);
					cache_get_field_content(row,  "SalmonProcessed", szResult, MainPipeline); PlayerInfo[extraid][pSalmonProcessed] = strval(szResult);
					cache_get_field_content(row,  "TunaProcessed", szResult, MainPipeline); PlayerInfo[extraid][pTunaProcessed] = strval(szResult);
					cache_get_field_content(row,  "CrabProcessed", szResult, MainPipeline); PlayerInfo[extraid][pCrabProcessed] = strval(szResult);
					cache_get_field_content(row,  "LobsterProcessed", szResult, MainPipeline); PlayerInfo[extraid][pLobsterProcessed] = strval(szResult);



					cache_get_field_content(row,  "MayCua", szResult, MainPipeline); PlayerInfo[extraid][pMayCua] = strval(szResult);
					cache_get_field_content(row,  "XangMC", szResult, MainPipeline); PlayerInfo[extraid][pXangMC] = strval(szResult);

					cache_get_field_content(row,  "TVCuopNG", szResult, MainPipeline); PlayerInfo[extraid][pTVCuopNG] = strval(szResult);

					cache_get_field_content(row,  "PhieuHouse", szResult, MainPipeline); PlayerInfo[extraid][pPhieuHouse] = strval(szResult);
					cache_get_field_content(row,  "MayKhoan", szResult, MainPipeline); PlayerInfo[extraid][pMayKhoan] = strval(szResult);
					cache_get_field_content(row,  "Scoin", szResult, MainPipeline); PlayerInfo[extraid][pScoin] = strval(szResult);
					
					cache_get_field_content(row,  "Titan", szResult, MainPipeline); PlayerInfo[extraid][pTitan] = strval(szResult);
					cache_get_field_content(row,  "Crom", szResult, MainPipeline); PlayerInfo[extraid][pCrom] = strval(szResult);
					cache_get_field_content(row,  "Wolfram", szResult, MainPipeline); PlayerInfo[extraid][pWolfram] = strval(szResult);
					cache_get_field_content(row,  "Ruteni", szResult, MainPipeline); PlayerInfo[extraid][pRuteni] = strval(szResult);
					cache_get_field_content(row,  "CanXang", szResult, MainPipeline); PlayerInfo[extraid][pCanXang] = strval(szResult);
					cache_get_field_content(row,  "MayKhoan", szResult, MainPipeline); PlayerInfo[extraid][pMayKhoan] = strval(szResult);
					cache_get_field_content(row,  "Mayquet", szResult, MainPipeline); PlayerInfo[extraid][pMayQuet] = strval(szResult);
					cache_get_field_content(row,  "Xang", szResult, MainPipeline); PlayerInfo[extraid][pXang] = strval(szResult);
					
					cache_get_field_content(row,  "iDE", szResult, MainPipeline); PlayerInfo[extraid][piDE] = strval(szResult);
					cache_get_field_content(row,  "iShotgun", szResult, MainPipeline); PlayerInfo[extraid][piShotgun] = strval(szResult);
					cache_get_field_content(row,  "iMp5", szResult, MainPipeline); PlayerInfo[extraid][piMp5] = strval(szResult);
					cache_get_field_content(row,  "iAk", szResult, MainPipeline); PlayerInfo[extraid][piAk] = strval(szResult);
					cache_get_field_content(row,  "iM4", szResult, MainPipeline); PlayerInfo[extraid][piM4] = strval(szResult);
					cache_get_field_content(row,  "iSniper", szResult, MainPipeline); PlayerInfo[extraid][piSniper] = strval(szResult);
					cache_get_field_content(row,  "iCombat", szResult, MainPipeline); PlayerInfo[extraid][piCombat] = strval(szResult);
					cache_get_field_content(row,  "iTec9", szResult, MainPipeline); PlayerInfo[extraid][piTec9] = strval(szResult);


					cache_get_field_content(row,  "KimCuong", szResult, MainPipeline); PlayerInfo[extraid][pKimCuong] = strval(szResult);
					cache_get_field_content(row,  "HCLD", szResult, MainPipeline); PlayerInfo[extraid][phcld] = strval(szResult);
					cache_get_field_content(row,  "HCVC", szResult, MainPipeline); PlayerInfo[extraid][phcvc] = strval(szResult);
					cache_get_field_content(row,  "gvrp", szResult, MainPipeline); PlayerInfo[extraid][pgvrp] = strval(szResult);
					cache_get_field_content(row,  "Baocat", szResult, MainPipeline); PlayerInfo[extraid][pbaocat] = strval(szResult);
					cache_get_field_content(row,  "Ximang", szResult, MainPipeline); PlayerInfo[extraid][pximang] = strval(szResult);
					cache_get_field_content(row,  "FinishWork", szResult, MainPipeline); PlayerInfo[extraid][pFinishWork] = strval(szResult);
					cache_get_field_content(row,  "Tai", szResult, MainPipeline); PlayerInfo[extraid][pTai] = strval(szResult);
					cache_get_field_content(row,  "Xiu", szResult, MainPipeline); PlayerInfo[extraid][pXiu] = strval(szResult);
					...
					cache_get_field_content(row,  "Weed", szResult, MainPipeline); PlayerInfo[extraid][pWeed] = strval(szResult);
		...
		case SENDDATA_THREAD:
		{
			if(GetPVarType(extraid, "RestartKick")) {
				...
				ABroadCast(COLOR_YELLOW, "{AA3333}He thong{FFFF00}: Tai khoan da duoc luu thanh cong", 1);
				SetTimer("FinishMaintenance", 1500, false);
				print("Tai khoan da duoc luu lai thanh cong");
			}
		...
		case LOGIN_THREAD:
		{
			for(new i;i < rows;i++)
			{
				...
				GetPVarString(extraid, "MatKhau", szBuffer, sizeof(szBuffer));
				...
				DeletePVar(extraid, "MatKhau");
				break;
			}
			if(IsPlayerMobile(extraid)) //Mobi
			{
				for(new o = 0; o < 9; o++)
				{
					PlayerTextDrawHide(extraid, LoginMobi[extraid][o]);
				}
			} 
			else 
			{ //PC
		    	for(new o = 0; o < 6; o++)
				{
					PlayerTextDrawHide(extraid, LoginPC[extraid][o]);
				}
			}
			CancelSelectTextDraw(extraid);
			g_mysql_LoadAccount(extraid);
			DeletePVar(extraid, "DaNhapMK");
			return 1;
		}
		case LOGIN_THREAD1:
		{
			for(new i;i < rows;i++)
			{
				...
				cache_get_field_content(i, "Key", szResult, MainPipeline);
				GetPVarString(extraid, "NhapEmail", szEmail1, sizeof(szEmail1));
				GetPVarString(extraid, "MatKhau", szBuffer, sizeof(szBuffer));
				WP_Hash(szPass, sizeof(szPass), szBuffer);

				format(query, sizeof(query), "UPDATE `accounts` SET `Email`='%s' WHERE `id`=%d", szEmail1, GetPlayerSQLId(extraid));
...
stock DisplayBangXepHangTaiSan(playerid)
{
    new query[150];
    format(query, sizeof(query), "SELECT `Username`, `Money`, `Bank` FROM `accounts` ORDER BY `Money` DESC LIMIT 10");
    mysql_function_query(MainPipeline, query, true, "BangXepHangTaiSan", "i", playerid);
}

stock DisplayBangXepHangCapDo(playerid)
{
    new query[150];
    format(query, sizeof(query), "SELECT `Username`, `Level` FROM `accounts` ORDER BY `Level` DESC LIMIT 10");
    mysql_function_query(MainPipeline, query, true, "BangXepHangCapDo", "i", playerid);
}

stock DisplayBangXepHangKimCuong(playerid)
{
    new query[150];
    format(query, sizeof(query), "SELECT `Username`, `KimCuong` FROM `accounts` ORDER BY `KimCuong` DESC LIMIT 10");
    mysql_function_query(MainPipeline, query, true, "BangXepHangKimCuong", "i", playerid);
}
...
stock g_mysql_SaveAccount(playerid)
{
    ...
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Verified", PlayerInfo[playerid][pVerified]);
    ...
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "FishermenSkill", PlayerInfo[playerid][pFishermenSkill]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "BuilderSkill", PlayerInfo[playerid][pBuilderSkill]);

    SavePlayerInteger(query, GetPlayerSQLId(playerid), "RentBoat", PlayerInfo[playerid][pRentBoat]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Shrimp", PlayerInfo[playerid][pShrimp]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Salmon", PlayerInfo[playerid][pSalmon]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Tuna", PlayerInfo[playerid][pTuna]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Crab", PlayerInfo[playerid][pCrab]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Lobster", PlayerInfo[playerid][pLobster]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "ShrimpProcessed", PlayerInfo[playerid][pShrimpProcessed]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "SalmonProcessed", PlayerInfo[playerid][pSalmonProcessed]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "TunaProcessed", PlayerInfo[playerid][pTunaProcessed]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "CrabProcessed", PlayerInfo[playerid][pCrabProcessed]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "LobsterProcessed", PlayerInfo[playerid][pLobsterProcessed]);


	SavePlayerInteger(query, GetPlayerSQLId(playerid), "CuopCuaHang", PlayerInfo[playerid][pCuopCuaHang]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "MayCua", PlayerInfo[playerid][pMayCua]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "XangMC", PlayerInfo[playerid][pXangMC]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "TVCuopNG", PlayerInfo[playerid][pTVCuopNG]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "KhatNuoc", PlayerInfo[playerid][pKhatNuoc]);

    SavePlayerInteger(query, GetPlayerSQLId(playerid), "MayKhoan", PlayerInfo[playerid][pMayKhoan]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Scoin", PlayerInfo[playerid][pScoin]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "PhieuHouse", PlayerInfo[playerid][pPhieuHouse]);
    
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "CanXang", PlayerInfo[playerid][pCanXang]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "MayQuet", PlayerInfo[playerid][pMayQuet]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Titan", PlayerInfo[playerid][pTitan]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Crom", PlayerInfo[playerid][pCrom]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Wolfram", PlayerInfo[playerid][pWolfram]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Ruteni", PlayerInfo[playerid][pRuteni]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "MayKhoan", PlayerInfo[playerid][pMayKhoan]);
    
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "iDe", PlayerInfo[playerid][piDE]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "iCombat", PlayerInfo[playerid][piCombat]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "iSniper", PlayerInfo[playerid][piSniper]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "iAk", PlayerInfo[playerid][piAk]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "iM4", PlayerInfo[playerid][piM4]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "iTec9", PlayerInfo[playerid][piTec9]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "iShotgun", PlayerInfo[playerid][piShotgun]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "iMp5", PlayerInfo[playerid][piMp5]);


    SavePlayerInteger(query, GetPlayerSQLId(playerid), "KimCuong", PlayerInfo[playerid][pKimCuong]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "HCLD", PlayerInfo[playerid][phcld]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "HCVC", PlayerInfo[playerid][phcvc]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "gvrp", PlayerInfo[playerid][pgvrp]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Baocat", PlayerInfo[playerid][pbaocat]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Ximang", PlayerInfo[playerid][pximang]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "FinishWork", PlayerInfo[playerid][pFinishWork]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Tai", PlayerInfo[playerid][pTai]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Xiu", PlayerInfo[playerid][pXiu]);
    ...
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Weed", PlayerInfo[playerid][pWeed]);
...
forward BangXepHangTaiSan(playerid);
public BangXepHangTaiSan(playerid)
{
    new rows, fields;
    cache_get_data(rows, fields, MainPipeline);

    if (rows == 0) {
        ShowPlayerDialog(playerid, DIALOG_NOTHING, DIALOG_STYLE_MSGBOX, " ", "Bug.", "Dong y", "");
        return 1;
    }

    new string[2000] = "Top\tNguoi choi\tTien Mat\tTien Ngan Hang\n";
	new playerRow[128];
    new playerName[128];
    new TienMat[128];
    new TienNganHang[128];

    for (new i = 0; i < rows; i++) {
		cache_get_field_content(i, "Money", TienMat, MainPipeline); 
		cache_get_field_content(i, "Bank", TienNganHang, MainPipeline); 
        cache_get_field_content(i, "Username", playerName, MainPipeline, 128);
        format(playerRow, sizeof(playerRow),
		"%d\t%s\t%d\t%d\n", i+1, playerName, strval(TienMat), strval(TienNganHang));
        strcat(string, playerRow);
    }

    ShowPlayerDialog(playerid, DIALOG_NOTHING, DIALOG_STYLE_TABLIST_HEADERS, "Bang Xep Hang", string, "OK", "");

    return 1;
}
forward BangXepHangCapDo(playerid);
public BangXepHangCapDo(playerid)
{
    new rows, fields;
    cache_get_data(rows, fields, MainPipeline);
    ...
    new string[2000] = "Top\tNguoi choi\tCap Do\n";
	new playerRow[128];
    new playerName[128];
    new CapDo[128];

    for (new i = 0; i < rows; i++) {
		cache_get_field_content(i, "Level", CapDo, MainPipeline); 
        cache_get_field_content(i, "Username", playerName, MainPipeline, 128);
        format(playerRow, sizeof(playerRow),
		"%d\t%s\t%d\n", i+1, playerName, strval(CapDo));
        strcat(string, playerRow);
    }
...
forward BangXepHangHuanChuong(playerid);
public BangXepHangHuanChuong(playerid)
{
    new rows, fields;
    cache_get_data(rows, fields, MainPipeline);
    ...
    if (rows == 0) {
 	...
 	new string[2000] = "Top\tNguoi choi\tHuan Chuong\n";
	new playerRow[128];
    new playerName[128];
    new gvrp[128];

    for (new i = 0; i < rows; i++) {
		cache_get_field_content(i, "gvrp", gvrp, MainPipeline); 
        cache_get_field_content(i, "Username", playerName, MainPipeline, 128);
        format(playerRow, sizeof(playerRow),
		"%d\t%s\t%d\n", i+1, playerName, strval(gvrp));
        strcat(string, playerRow);
    }
...
public OnBanPlayer(index)
{
	...
	if(IsPlayerConnected(index))
	{
		if(mysql_affected_rows(MainPipeline)) {
			...
			strcpy(PlayerInfo[index][pBannedBy], name, MAX_PLAYER_NAME);
			format(PlayerInfo[index][pReasonBanned], 128, "%s", reason);

			format(string, sizeof(string), "AdmCmd: %s da cam tai khoan (%s gio) - (%s) [OFFLINE], ly do: %s", name, number_format(PlayerInfo[index][pTimeBannedPlayer]), GetPlayerNameEx(index), reason);
			Log("logs/ban.log", string);
			
			format(string, 128, "AdmCmd: %s da bi cam tai khoan (%s gio) - (%s) [OFFLINE], ly do: %s", name, number_format(PlayerInfo[index][pTimeBannedPlayer]), GetPlayerNameEx(index), reason);
			ABroadCast(COLOR_LIGHTRED,string,2);
			print(string);
			
			PlayerInfo[index][pTimeBannedPlayer] = 0;
		}
		else {

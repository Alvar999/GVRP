...
#define			XP_RATE						2 // XP Rates for jobs
...
#define 		CHECKPOINT_RETURNFISHING	(5079)
#define 		TYPE_TPFISHERMENTIMER		(5080)
#define 		CHECKPOINT_TUTORIALFISHING	(5081)
#define 		CHECKPOINT_FISHING			(5082)
#define 		DIALOG_GETJOB				(5083)
#define 		DIALOG_CHEBIENHAISAN		(5084)
#define 		DIALOG_GIAODICHHAISAN		(5085)
#define 		DIALOG_FINDJOB				(5086)
#define 		TIMBOSS						(5087)
#define 		DIALOG_BANGXEPHANG			(5088)
#define 		DIALOG_BUONLAUCANSA			(5089)
#define 		DIALOG_VITRIBUONLAUCANSA	(5090)
#define 		CHECKPOINT_MAP				(5091)
#define 		DIALOG_TRAODOITHUOC			(5092)
#define 		DIALOG_TRAODOIVUKHI			(5093)
#define 		DIALOG_TRAODOIVATLIEU		(5094)
#define			CHETAODAN					(5095)
#define			DIALOG_NHAPMATKHAU			(5096)
#define			DIALOG_NHAPMATKHAU1			(5097)
#define 		DIALOG_NHAPEMAIL 			(5098)
#define 		DIALOG_SHOPMOBI 			(5099)
#define 		DIALOG_TIMDUONG 			(6000)
#define 		DIALOG_SHOPSKIN 			(6001)


#define 		DIALOG_XINVIECContainer     (6002)
#define 		DIALOG_XINVIECContainer2    (6003)

#define POS_PIZZA			2103.8977,-1790.4053,13.5547
#define POS_TRUCKER			2443.0298,-2121.3218,13.5469
#define POS_FISHERMEN		162.8643,-1936.6799,3.7734
#define POS_WORKER			2057.4934,-1999.6221,13.5469
...
#define			AUTO_MESSAGE				1
#define			AUTO_MESSAGE_BOX			2
